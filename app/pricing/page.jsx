                    ...
                    >
                      ...
                      >
                        ...
                        <p className="mb-6 text-lg text-black transition-all duration-300 ease-linear group-hover:text-white">
                          Ideal for individuals and small businesses exploring
                          AI solutions.
                        </p>
                        {/* Price Info List */}
                      ...
                      >
                        ...
                        <p className="mb-6 text-lg text-black transition-all duration-300 ease-linear group-hover:text-white">
                          Great for teams and small businesses starting to
                          explore AI models.
                        </p>
                        {/* Price Info List */}
                        <ul className="mb-10 flex flex-col gap-y-3">
                      ...
                      >
                        ...
                        <p className="mb-6 text-lg text-black transition-all duration-300 ease-linear group-hover:text-white">
                          Best for medium-scale businesses with data-driven
                          operations.
                        </p>
                        {/* Price Info List */}
                        <ul className="mb-10 flex flex-col gap-y-3">
                      ...
                      >
                        ...
                        <p className="mb-6 text-lg text-black transition-all duration-300 ease-linear group-hover:text-white">
                          Perfect for enterprises managing complex workflows and
                          data systems.
                        </p>
                        {/* Price Info List */}
                        <ul className="mb-10 flex flex-col gap-y-3">
