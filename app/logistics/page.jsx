          ...
          useEffect(() => {
            const filteredData = () => {
              const filtered = data.filter((item) =>
                item.catagory.includes("logistics")
              );
            ...
            <div className="breadcrumb-wrapper">
              ...
              <div className="global-container">
                <div className="breadcrumb-block">
                  <h1 className="breadcrumb-title">Logistics</h1>
              ...
              <div className="global-container ">
                <div className="my-20">
                  <h1 className=" text-5xl text-center">
                    Revolutionize Logistics with
                    <span className="text-colorOrangyRed mx-1">AI-Powered</span>
                    Insights
                  </h1>
                  <p className="text-center my-4">
                    Workmate simplifies your supply chain operations by
                    predicting challenges, optimizing routes, and driving
                    smarter decisions—powered by cutting-edge AI.
                  </p>
                  <div>
