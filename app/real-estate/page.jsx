  ...
  useEffect(() => {
    const filteredData = () => {
      const filtered = data.filter((item) =>
        item.catagory.includes("real-estate")
      );
          ...
          <div className="breadcrumb-wrapper">
            ...
            <div className="global-container">
              <div className="breadcrumb-block">
                <h1 className="breadcrumb-title">Real Estate</h1>
            ...
            <div className="global-container ">
              <div className="my-20">
                <h1 className=" text-5xl text-center">
                  ...
                  <span className="text-colorOrangyRed mx-1">AI-Driven</span>
                  Insights
                </h1>
                <p className="text-center my-4">
                  Workmate leverages cutting-edge AI to streamline property
                  management, optimize investments, and unlock smarter
                  decision-making across the real estate market.
                </p>
                <div>
