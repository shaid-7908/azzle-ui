              ...
              <div className="breadcrumb-wrapper">
                ...
                <div className="global-container">
                  <div className="breadcrumb-block">
                    <h1 className="breadcrumb-title">Sales & Marketing</h1>
                ...
                <div className="global-container ">
                  <div className="my-20">
                    <h1 className=" text-5xl text-center">
                      Transform Your
                      <span className="text-colorOrangyRed mx-1">
                    ...
                    >
                      ...
                      <div className="text-lg leading-[1.4] lg:text-[21px]">
                        <p className="mb-7 last:mb-0">
                          Our AI SaaS solutions can be quickly deployed,
                          enabling users to start benefiting from AI
                          capabilities without lengthy setup and development
                          times in fast-paced industries.
                        </p>
                        <Link
                          href="/faq-1"
                          className="button mt-5 rounded-[50px] border-2 border-black bg-black py-4 text-white after:bg-colorOrangyRed hover:border-colorOrangyRed hover:text-white"
                        ...
                        >
                          ...
                          <div className="accordion-content text-[#2C2C2C]">
                            <p>
                              ...
                              with automation to streamline processes, enhance
