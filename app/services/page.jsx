...
function Services() {
    ...
    <>
      ...
      <main className="main-wrapper relative overflow-hidden">
        ...
        <section id="workmate-service-custom">
          <div id="main-div-for-wsc" className="pr-4 pl-4 my-[60px] mb-[200px]">
            <div className="flex">
              <div className="flex-[60%]">
                <div className="relative">
                  ...
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    className="absolute bg-[#FE330A] h-[80px] z-10 top-0 text-[#FE330A] w-[250px] p-2"
                  ></motion.div>
                </div>
                <div className="my-[20px]">
                  ...
                  >
                    ...
                    that enhance data insights with dynamic visualization and
                    optimize collaboration across business verticals, ensuring
                    maximum value from your enterprise data.
                  </motion.p>
                </div>
                <hr className="w-[80%]" />
                  ...
                  <div>
                    <div className="relative p-4">
                      ...
                      <motion.div
                        ...
                        transition={{ duration: 0.6 }}
                        viewport={{ once: true }}
                        className="bg-[#FE330A] w-[50px] h-[45px] absolute top-1 left-1 z-10 "
                      ></motion.div>
                    </div>
                    <div>
                      <motion.p
              ...
              <div className="flex-[40%] ">
                <Image src="/ai-block3.png" alt="ai" width={800} height={800} />
              </div>
            </div>
          </div>
        </section>
